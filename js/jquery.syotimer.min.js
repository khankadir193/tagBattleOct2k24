!(function (e) {
  ...
  const r = {
    ...
    afterDeadline: function (e) {
      e.bodyBlock.html(
        '<p style="color: #fff; font-family: "Cinzel";font-size:4.53vw">Event has been Ended</p>'
      );
    },
  };
  var a = {
      init: function (t) {
        ...
        return (
          t.hasOwnProperty("dubleNumbers") &&
            (i.doubleNumbers = t.dubleNumbers),
          this.each(function () {
            var t = e(this);
      ...
      _perSecondHandler: function () {
        ...
        d >= 0
          ? (a._refreshUnitsDom.apply(this, [d]),
            a._applyEffectSwitch.apply(this, [i.effectType]))
      ...
      _refreshUnitsDom: function (t) {
        ...
        for (var l = 0; l < r.length; l++) {
          var c = r[l],
            u = "." + c;
          e(u + " .tab-val", i).html(
            s.format2(a[c], "day" != c && o.doubleNumbers)
          ),
            e(u + " .tab-unit", i).html(
              s.definitionOfNumerals(a[c], d[c], o.lang)
            );
        }
      },
    ...
    s = {
      getCellDom: function (e, t) {
        return (
          ...
          '<div class="table-cell ' +
            ...
            '"><div class="tab-val">' +
            t +
            '</div><div class="tab-metr tab-unit"></div></div>'
        );
      },
      getSecondsToDeadLine: function (e, t) {
        ...
        if (((o = Math.floor(o)), t.periodic)) {
          ...
          (d = Math.ceil(d)),
            (d = Math.abs(d)),
            o >= 0
              ? ((r = d % t.periodInterval),
                (r = 0 == r ? t.periodInterval : r),
                (r -= 1))
              : (r = t.periodInterval - (d % t.periodInterval)),
            (n = o % a),
            0 == n && o < 0 && r--,
            (i = Math.abs(r * a + n));
        } else i = o;
      ...
      getUnitsToDeadLine: function (e) {
        for (
          var t = ["day", "hour", "minute", "second"], i = {}, o = 0;
          o < t.length;
          o++
        ) {
          var n = t[o],
      ...
      definitionOfNumerals: function (e, t, i) {
        switch (i) {
          case "rus":
            ...
            return (
              (o =
                e % 100 > 4 && e % 100 < 20 ? 2 : n[e % 10 < 5 ? e % 10 : 5]),
              t[o]
            );
          case "eng":
            return t[1 == e ? 0 : 1];
